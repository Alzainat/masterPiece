        ...
        <div class="py-10">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1">
                    <h3 class="text-lg font-semibold mb-4">{{ config('app.name', 'Your Company') }}</h3>
                    <p class="text-gray-400 mb-4">Your trusted partner for web solutions and digital experiences.</p>
                ...
                <div class="col-span-1">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ url('/hotels') }}" class="text-gray-400 hover:text-white">Hotels</a></li>
                ...
                {{-- <div class="col-span-1">
                    ...
                    <p class="text-gray-400 mb-4">Subscribe to our newsletter to get the latest updates.</p>
                    <form action="#" method="POST" class="flex flex-col space-y-2">
                        <input 
                            type="email" 
                            name="email" 
                            placeholder="Enter your email" 
                            class="px-4 py-2 bg-gray-800 text-white rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required
                        >
