<table class="table table-striped table-hover usersTable">
  ...
  <tbody>
    @if (count($hotels))
      @foreach ($hotels as $hotel)
        <tr>
          ...
          <td>
            <img src="{{ $hotel->image != null ? asset('storage/' . $hotel->image) : asset('images/hotel_default.jpg') }}" 
                 alt="{{ $hotel->name }}" 
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href=" {{ route('admin.hotels.show', $hotel['id'], $hotel['name']) }}">
                  <i class="bi bi-eye"></i> View Rooms</a></li>
                <li>             
                <li>
    ...
    @else
      <tr>
        <td colspan="6" class="text-center py-2">No Hotels Found</td>
      </tr>
    @endif
  </tbody>
</table>
